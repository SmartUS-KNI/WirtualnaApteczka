...
public class MonthlyDoseAdjustmentDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.dialog_monthly_dosage_adjustment, null);
        builder
                .setTitle(R.string.pickDaysOfMonth)
                .setPositiveButton(R.string.save, (dialogInterface, i) -> {
                    LayoutContentConfig layoutContentConfig = new LayoutContentConfig();
                    layoutContentConfig.addLayoutContentConfigParam(ELayoutContentType.LAYOUT_CONTENT_TYPE_CHECKBOX);
